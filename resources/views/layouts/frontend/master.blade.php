...
<body class="fixed-header">
	...
	<!-- End Google Tag Manager (noscript) -->
		...
		<a href="#." id="btn_call_me" data-toggle="modal" data-target="#call-me" class="btn btn-primary floating" data-text="&nbsp;&nbsp;&nbsp;&nbsp;Je veux me faire appeler"><i class="icon-telephone114"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Besoin d'aide ?&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
		<!-- Footer -->
		<footer id="footer">
