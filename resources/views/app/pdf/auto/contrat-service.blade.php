...
<main>
  ...
  <div>
    ...
    <p align="justify">
      ...
      <p align="justify">Les interventions du Prestataire dans le cadre de la présente convention seront limitées uniquement aux sinistres survenus dans le périmètre du District d’Abidjan. Les parties pourront, toutefois, convenir ensemble d’une couverture sur un périmètre plus large moyennant une facturation complémentaire.</p>

      <p align="justify">
        <b><u>Article 4</u> : Modalités d’exécution de la prestation</b>
        Le Prestataire s’engage, en vertu de la présente convention, à mettre à la disposition du Client, un service d’assistance en cas de survenance de sinistre ou dommage causé au véhicule ou par le véhicule du Client.
      </p>
      <p align="justify">
        De façon pratique, le Prestataire enverra sur les lieux du sinistre, soit, des agents dont la mission sera de procéder à un constat à l’amiable entre le Client et la victime, soit des agents de police pour effectuer le constat d’accident.
      </p>
      <p align="justify">
      ...
      <p>
        Le Client reconnaît en conséquence qu’il reçoit et prend directement à sa charge toute action ou réclamation émanant des tiers. Le Client défendra, indemnisera et tiendra le Prestataire indemne de toute réclamation, plainte, revendication ou attaque de quelque nature que ce soit émanant de tiers résultant de, ou liée au sinistre intervenu de son fait ou dû à sa négligence.
      </p>
      <p>
