...
<section class="subpage-header">
	<div class="container">
		...
		<a href="{{route('page.quote.auto')}}" class="btn btn-primary get-in-touch" data-text="Demander un dévis"><i class="fa fa-file-o"></i>Comparer dévis</a>
	</div>
</section>
...
<section class="different-services text-center parallax" style="margin-top:30px;">
	<div class="container">
		<div class="heading animate bounceIn">
			...
			<br>
			<a href="{{route('page.quote.auto')}}" class="btn btn-primary get-in-touch" data-text="Comparer dévis"><i class="fa fa-file-o"></i>Comparer dévis</a>
		</div>
	</div>
					...
					<div class="services text-center">
						<div class="three-items-carousel owl-carousel">
							...
							<div class="service-box">
								...
								<h4>Declarer un sinistre</h4>
								<p>Déclarer votre sinistre en quelques clique sur www.monassurance.ci</p>
								<a href="#" class="btn-link">En savoir plus</a>
							</div>
